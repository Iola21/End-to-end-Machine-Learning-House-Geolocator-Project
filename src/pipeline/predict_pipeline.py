...
class CustomData:
    def __init__(self, easting: int, northing: int, longitude: int, latitude: int, housing_median_age: int, total_rooms: int, total_bedrooms: int, population: int, households: int, median_income: int, ocean_proximity: str):
