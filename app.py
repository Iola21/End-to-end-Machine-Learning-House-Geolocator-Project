...
def main():
    ...
    easting = st.sidebar.number_input('Easting', value=0.0, step=1)
    northing= st.sidebar.number_input('Northing', value=0.0, step=1)
    ...
    custom_data = CustomData(easting, northing, longitude, latitude, housing_median_age, total_rooms, total_bedrooms,
